	...
	<div id="content" class="login-content">
		...
		<div class="content-container">
			<div class="content-layout">
				<% If false Then '14세 미만일 때 %>
				<div class="form-area pt25">
					<dl>
						<dt>이름<span class="color-red">*</span></dt>
						<dd>
							<div class="form-type">
								<label class="input-text">
									<input type="text" name="" id="" value="" placeholder="김무스비" disabled>
								</label>
							</div>
						</dd>
						...
						<dd>
							...
							<span class="info-txt mt5 mb20">6자 이상의 영문, 영문+숫자조합 </span>
						</dd>
							...
							<div class="form-type">
								<div class="row">
									<label class="input-text">
										...
										<button type="button" class="btn btn-search color-black">변경</button>
									</label>
								</div>
							</div>
						...
						<dd>
							<div class="form-type">
								...
								<div class="row border-none">
									<a href="javascript:void(0);" class="btn btn-border-black">변경</a>
								</div>
							</div>
						</dd>
						...
						<dt>주소<span class="color-red">*</span>
						<span class="info-txt color-red mb10">주소를 변경해도 배송지는 변경되지 않습니다. 상품 배송지 변경 희망 시 고객센터 (1:1 상담)에 문의 글을 남겨주세요.</span>
						</dt>
						<dd>
					...
					<dl>
						...
						<dd>
							<div class="form-type">
								...
								<span class="info-txt mb20">주문/배송 정보를 SMS로 안내해 드리오니 정확하게 입력해주세요.</span>
							</div>
						</dd>
			...
			<div class="content-layout">
				...
				<div class="input-area">
					...
					<div class="cart-content">
						<ul>
							<li>
								<label class="input-checkbox"><!-- onclick="fnOpenModal('.modal-order');"-->
									<input type="checkbox">
									<i class="ico-checkbox"></i>
				...
				<div class="info-area pt0 txt-right">
					<a href="./registMemQuit.asp" class="txt-underline">시대인재 회원 탈퇴</a>
				</div>
			</div>
